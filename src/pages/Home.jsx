...
function Home() {
  ...
  return (
    <div className="flex-1 ml-40 mr-40">
      ...
      <div className="border-t-2 border-red-500 w-32"></div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-10">
        {books.map((book, index) => (
          <div
            className="rounded-lg shadow-xl flex flex-col space-y-4 border-black transition duration-300 transform hover:-translate-y-5"
            key={index}
          >
            ...
            <div className="p-5">
              ...
              <p className="line-clamp-2 h-14 mt-2">{book.description.slice(0, 35) + "..."}</p>
